...
# nome da branch: <tipo>/<UNIQUE-ID>/<slug>   (ver docs/07-tracking-notion.md)
git checkout -b feature/GFD-42/saudacao-pt-br
```
...
git commit -m "feat(app): Melhora mensagem de boas-vindas" \
           -m "Notion: GFD-42"
git push -u origin feature/GFD-42/saudacao-pt-br
```
